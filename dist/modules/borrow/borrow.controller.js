...
exports.borrowGet = exports.borrowCreate = void 0;
...
const borrowCreate = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield book_model_1.default.updateAvailability(bookId, book.copies);
        yield book.save();
...
const borrowGet = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
